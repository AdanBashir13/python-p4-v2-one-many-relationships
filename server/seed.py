...
with app.app_context():
    ...
    uri_2023 = Review(year=2023, summary="Great web developer!", employee_id = uri.id)
    tristan_2021 = Review(year=2021, summary="Good coding skills, often late to work", employee_id = tristan.id)
    tristan_2022 = Review(year=2022, summary="Strong coding skills, takes long lunches", employee_id = tristan.id)
    tristan_2023 = Review(year=2023, summary="Awesome coding skills, dedicated worker", employee_id = tristan.id)
